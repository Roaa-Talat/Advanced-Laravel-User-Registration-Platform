<footer>
    <div class="footer-content">
      ...
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet">
        <h3>{{__('strings.About Our Company')}}</h3>
        <p>{{__('strings.AboutCompany')}}</p>
      </div>
      <ul class="footer-links">
        ...
        <li><a href="https://github.com/rawwaanntarekk/Registration-webpage/tree/main">{{__('strings.Services')}}</a></li>
        <li><a href="https://github.com/rawwaanntarekk/Registration-webpage/tree/main">{{__('strings.Contact')}}</a></li>
      </ul>
      <div class="footer-social">
        <h3>{{__('strings.Follow Us')}}</h3>
